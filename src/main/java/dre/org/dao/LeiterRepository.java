...
public interface LeiterRepository extends LehrerRepository {
	...
	@Query(value="select"
			...
			+ "join sprachelehrer s on  p.username = s.username_personne  where p.type_compte='LEITER'", nativeQuery = true)
