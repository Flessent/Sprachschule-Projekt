...
@NoArgsConstructor
@AllArgsConstructor
public @Data class LeiterDTO extends LehrerDTO {
	private Integer nbreMoisExperiences;
	private BigDecimal  salaire;
	private Set<UUID> sprache;
	private Set<UUID> niveau;
	
	public LeiterDTO(String username,String nom,String prenom,Date dateNaissance,String nationalite, String profession, String quartier,String numTel,  String email,String numCni,String password,
